...
$(document).ready(function(){
    ...
    const mostraMsgMes = (texto) =>{
        ...
        switch(texto){
            ...
            case "final": titulo = "14 de Janeiro de 2023"; mensagem = "<section class='text-center mt-5 mb-5'><p><strong>O dia em que ele disse<br><span class='letra2 letra-vermelha'>SIM. Obrigado por estar cmg e aturar minhas loucuras, te gosto muito. Espero que você esteja chorando, da pra me beijar agr???</span></strong></p></section>";break;
        }
